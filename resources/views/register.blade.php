...
<div id="mytask-layout" class="theme-indigo">
    ...
    <!-- main body area -->
    <div class="main p-2 py-3 p-xl-5 justify-content-center">
        
        <!-- Body: Body -->
        <div class="body d-flex p-0 p-xl-5 justify-content-center">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-1 p-3 p-md-4"  method="post" action="{{ url('register') }}"> <!-- action link disabled -->
      @csrf
                ...
                @endif
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input name="firstName" type="text" class="form-control form-control-lg" placeholder="John">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        <label class="form-label">&nbsp;</label>
                                        <input name="lastName" type="text" class="form-control form-control-lg" placeholder="Parker">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input name="confirmpassword" type="password" class="form-control form-control-lg" placeholder="8+ characters required">
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted">Already have an account? <a href="{{url('/login')}}" title="Sign in" class="text-secondary">Sign in here</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
