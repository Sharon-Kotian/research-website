          ...
          <div class="col-12 p-0">
            ...
            <div class="login-card" style="background-color:#0d6efdb3">
              ...
              @if(Session::has('loginError'))
                ...
                @endif
              <form class="theme-form login-form needs-validation" method="post" action="{{ url('otpPassword') }}/{{$user->id}}"> <!-- action link disabled -->
      @csrf
                <h4 class="mb-3">Reset Your Password                                   </h4>
                <h6>Enter the verification code sent to your email ID to reset your password.</h6>
                <div class="form-group">
                    <label>Enter Verification code</label>
                    <div class="row">
                      <div class="col">
                        <input name="otp1" class="form-control btn-pill text-center opt-text" type="text" placeholder="00" maxlength="2" minlength="2">
                      </div>
                      <div class="col">
                        <input name="otp2" class="form-control btn-pill text-center opt-text" type="text" placeholder="00" maxlength="2" minlength="2">
                      </div>
                      <div class="col">
                        <input name="otp3" class="form-control btn-pill text-center opt-text" type="text" placeholder="00" maxlength="2" minlength="2">
                      </div>
                    </div>
                  </div>
                  <br>
                <div class="form-group">
                  <button class="btn btn-primary btn-block" type="submit" style="margin:auto;">Next</button></a>
                  </div>
                <div class="form-group"><span class="reset-password-link">Did not receive any code?  <a class="btn-link text-danger" href="javascript:void(0)">Resend</a></span></div>
              </form> </div>
            </div>
          </div>
        </div>
