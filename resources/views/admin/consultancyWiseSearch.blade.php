...
<head>
    ...
    <title>:: My-Profile:: Consultancy Wise Search</title>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Consultancy Wise Search</h3>
...
<div id="name_div">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ url('admin/searchConsultancy')}}">
                            @csrf
    ...
    <div style="margin-left:-600px;margin-top:300px;width:100%"> 
               <table id="data_table" style="border:1px solid red;border-collapse:collapse;width:100%;font-size:15px;">
                        <tr>
                            ...
                            <th>Concerned Person Contact Number</th>
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>Female</td>
                                @endif -->
                                <td>{{$user->desc_of_task}}</td>
                                <td>{{$user->concerned_person_name}}</td>
                                <td>{{$user->concerned_person_contact_number}}</td>
                                <td>{{$user->assignment_name}}</td>
                                <td>{{$user->amount_received}}</td>
