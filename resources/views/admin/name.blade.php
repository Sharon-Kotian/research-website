...
<?php $user = Auth::guard('admin')->user(); ?>
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
               ...
               <div class="grid-container"> 
                <div class="col">
                        <div class="card teacher-card" style="height:200px;width:550px;background-image: linear-gradient(to bottom right, orange, yellow);" >
  ...
  Name : {{$user->firstName}} {{$user->lastName}}<br>
                    Total No. of Patents : {{$rdu->count}}</div> 
</div>
@endforeach 
...
<div style="text-align:center">
  ...
  <span class="dot1" onclick="currentSlide1(5)"></span> 
                        ...
                        <div class="col">
                        <div class="card teacher-card" style="height:200px;width:550px;margin-top:-200px;margin-left:600px;background-image: linear-gradient(to bottom right, DeepPink, DarkSalmon);">
  ...
  <div class="text" style="margin-top:-100px;margin-left:60px;color:white;font-size:17px;"> 
  Name : {{$user->firstName}} {{$user->lastName}}<br>
                    Total No. of Papers : {{$rdu->count}}</div> 
</div>
@endforeach 
