...
<head>
    ...
    <title>:: My-Profile:: Conference Wise Search</title>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Conference Wise Search</h3>
...
<div id="name_div">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ url('admin/searchConference')}}">
                            @csrf
                ...
                <a href="{{url('/admin/file/download/4')}}" class="btn btn-primary">Download</a>
               ...
               <table id="data_table" style="border:1px solid red;border-collapse:collapse;width:100%;font-size:15px;">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{$user->lastName}}</td>    
                                <td>{{$user->conference_organization_name}}</td>
                                <td>{{$user->conference_name}}</td>
                                <td>{{$user->conference_venue}}</td>
                                <td>{{$user->conference_date}}</td>
