...
<head>
    ...
    <title>:: My-Profile:: FDP Wise Search</title>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">FDP Wise Search</h3>
...
<div id="name_div">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ url('admin/searchFDP')}}">
                            @csrf
