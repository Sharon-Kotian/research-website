...
<head>
    ...
    <title>:: My-Profile:: Project</title>
    ...
    <script>
        function display(){
        document.getElementById('funded1').style.display = "block"
      }

      function hide(){
        document.getElementById('funded1').style.display = "none"
      }
    </script>
</head>
<body>
...
<?php $user = Auth::guard('admin')->user(); ?>
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <!-- Body: Header -->
        <div class="header">
         <!-- <center><img src="{{url('mit_logo.png')}}" alt="" width=400 height=100></center>  -->
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                ...
                                <button type="button" class="btn btn-dark me-1 mt-1 w-sm-100" data-bs-toggle="modal" data-bs-target="#createemp"><i class="icofont-plus-circle me-2 fs-6"></i>Add Project</button>
                ...
                <?php
                    $pros=\App\Models\Projects::where("user_id",$user->id)->get();
                ?>
                        ...
                        <div class="card teacher-card">
                            <!--<div class="card-body d-flex">-->
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    <h6 class="mb-0 mt-2  fw-bold d-block" style="font-size:20px">{{$pro->project_name}}</h6>
                                    @if($pro->funded==1)
                                    <span class="light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{{$pro->field_of_study}}</span>&nbsp&nbsp&nbsp&nbsp&nbsp<span class="light-success-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">Funded</span>&nbsp&nbsp&nbsp&nbsp&nbsp<span class="light-success-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{{$pro->funded_by}}</span>
                                    @else
                                    <span class="light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{{$pro->field_of_study}}</span>&nbsp&nbsp&nbsp&nbsp&nbsp<span class="light-danger-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">Non-Funded</span>
                                    @endif
                                    <div class="video-setting-icon mt-3 pt-3 border-top">
                                        <p><b>From :</b> {{$pro->start_date}} &nbsp&nbsp  <b>To :</b> {{$pro->end_date}}</p>
                                        @if($pro->sponsoring_agency!=null)
                                            <p>Sponsoring Agency : {{$pro->sponsoring_agency}}</p>
                                            <p>Amount of Funding : {{$pro->funding_amount}}</p>
                                        @endif
                                        <p>Publication out of Project : {{$pro->publication_out_of_project}}</p>
                                        <p>{{$pro->description}}</p>

                                    </div>
                                    <a href="{{url('/user/editProject')}}/{{$pro->id}}"class="btn btn-dark btn-sm mt-1"><i class="icofont-edit-alt me-2 fs-6"></i>Edit Project</a>
                                    <a href="{{url('/user/deleteProject')}}/{{$pro->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-delete-alt me-2 fs-6"></i>Delete Project</a>
                                </div>
                            <!--</div>-->
                        </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Add Project</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/addProject')}}/{{$user->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            ...
                            <input name="project_name" type="text" class="form-control" id="exampleFormControlInput877" placeholder="Enter Project Name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div id="funded1">
                            <div class="mb-3">
                                ...
                                <input name="funded_by" type="radio" style="width:30px" id="exampleFormControlInput977" value="UGC">UGC<br>
                                <!--<label for="exampleFormControlInput277" class="form-label">Non-Funded</label>-->
                            ...
                            <div class="mb-3">
                                ...
                                <input name="funding_amount" type="number" class="form-control" id="exampleFormControlInput677" placeholder="Enter Funding Amount">
                            </div>
                        </div>
