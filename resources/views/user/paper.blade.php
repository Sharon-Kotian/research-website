...
<head>
    ...
    <title>:: My-Profile:: Publication-Paper</title>
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Paper</h3>
                                <button type="button" class="btn btn-dark me-1 mt-1 w-sm-100" data-bs-toggle="modal" data-bs-target="#createemp"><i class="icofont-plus-circle me-2 fs-6"></i>Add Paper
                            </button>
                ...
                <?php
                    $edus=\App\Models\Paper::where("user_id",$user->id)->get();
                ?>
                        ...
                        <div class="card teacher-card">
                            <!--<div class="card-body d-flex">-->
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    <h6 class="mb-0 mt-2  fw-bold d-block" style="font-size:20px">{{$edu->paper_topic}}</h6>
                                    ...
                                    <div class="video-setting-icon mt-3 pt-3 border-top">
                                        ...
                                        <p><b>Category of Journals :</b> {{$edu->category_of_journal}}</p>
                                        <p><b>Authors/Co-Authors :</b> {{$edu->authors_co_authors}}</p>
                                        <p><b>Status :</b> {{$edu->status}}</p>
                                        <p><b>Volume :</b> {{$edu->volume}}</p>
                                        <p><b>Citation :</b> {{$edu->citation}}</p>
                                        <p><b>Page Number :</b> {{$edu->page_number}}</p>
                                        <p><b>Paper Link :</b> <a href="{{$edu->paper_link}}">{{$edu->paper_link}}</a></p>

                                        <p><b>From :</b> {{$edu->start_date}} &nbsp&nbsp  </p>
                                        <p>{{$edu->description}}</p>
                                    </div>
                                    <a href="{{url('/user/editPaper')}}/{{$edu->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-edit-alt me-2 fs-6"></i>Edit Paper</a>
                                    <a href="{{url('/user/deletePaper')}}/{{$edu->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-delete-alt me-2 fs-6"></i>Delete Paper</a>
                                </div>
                            </div>
                        <!--</div>-->
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Add Paper</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/addPaper')}}/{{$user->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            ...
                            <input name="paper_topic" type="text" class="form-control" id="exampleFormControlInput877" placeholder="Enter Paper Topic">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput977" class="form-label">Journal Name</label>
                            <input name="publication_name" type="text" class="form-control" id="exampleFormControlInput977" placeholder="Enter Publication Name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="volume" type="text" class="form-control" id="exampleFormControlInput677" placeholder="Enter Field of Study">
                        </div>
                        
                        
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Page Number</label>
                            <input name="page_number" type="text" class="form-control" id="exampleFormControlInput677" placeholder="Enter Page Number">
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="paper_link" type="text" class="form-control" id="exampleFormControlInput677" placeholder="Enter Paper Link">
                        </div>
                        
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Citation</label>
                            <input name="citation" type="text" class="form-control" id="exampleFormControlInput677" placeholder="Enter Citation">
                        </div>
                        ...
                        <div class="mb-3">          
                            ...
                            <input type="file" name="paper_pdf" accept="application/pdf">
