                ...
                @endif
                  <div class="mb-3">     
                        ...
                        <div class="mb-3">          
                            ...
                            <label for="exampleFormControlTextarea78" class="form-label">View pdf</label>
                            <button type="submit" class="btn btn-primary" onclick=" window.open true;">View pdf</button>
                        </div> 
