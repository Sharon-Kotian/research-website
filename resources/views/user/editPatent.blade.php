        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                <div class="row clearfix">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/editPatent')}}/{{$PatentDetails->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            ...
                            <input name="patent_title" type="text" class="form-control" id="exampleFormControlInput877" value="{{$PatentDetails->patent_title}}" placeholder="Enter Title of Patent">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Name of Granting Agency</label>
                            <input name="granting_agency" type="text" class="form-control" id="exampleFormControlInput677" value="{{$PatentDetails->granting_agency}}" placeholder="Enter Name of Granting Agency">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Year</label>
                            <input name="year" type="number" min="1900" max="2099" class="form-control" id="exampleFormControlInput677" value="{{$PatentDetails->year}}" placeholder="Enter Year">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Domain</label>
                            <input name="domain" type="text" class="form-control" id="exampleFormControlInput677" value="{{$PatentDetails->domain}}" placeholder="Enter Domain">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Name of Patent Holders</label>
                            <input name="patent_holders" type="text" class="form-control" id="exampleFormControlInput677" value="{{$PatentDetails->patent_holders}}" placeholder="Enter Name of Patent Holders">
                        </div>
                        <div class="mb-3">
                            ...
                            @if($PatentDetails->status=="Submitted")
                            <input name="status" type="radio" style="width:30px" id="exampleFormControlInput977" value="Submitted" checked>Submitted
                            ...
                            <!--<label for="exampleFormControlInput277" class="form-label">Non-Funded</label>-->
                            <input name="status" type="radio" style="width:30px" id="exampleFormControlInput277" value="Granted" checked>Granted
                            @endif
                            
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput677" class="form-label">Patent Link</label>
                            <input name="patent_link" type="text" class="form-control" id="exampleFormControlInput677" value="{{$PatentDetails->patent_link}}" placeholder="Enter Patent Link">
                        </div>
                        <div class="mb-3">          
                            <label for="exampleFormControlTextarea78" class="form-label">Add PDF of Patent</label>
                            <input type="file" name="patent_pdf" accept="application/pdf"><br>
                            <a class="btn btn-primary" href="{{asset('patent_pdf/'.$PatentDetails->patent_pdf_path)}}">View Your Uploaded PDF</a>
