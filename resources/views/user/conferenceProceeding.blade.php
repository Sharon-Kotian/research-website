    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                ...
                                <button type="button" class="btn btn-dark me-1 mt-1 w-sm-100" data-bs-toggle="modal" data-bs-target="#createemp"><i class="icofont-plus-circle me-2 fs-6"></i>Add Conference Proceeding
                            </button>
                ...
                <?php
                    $edus=\App\Models\ConferenceProceeding::where("user_id",$user->id)->get();
                ?>
                        ...
                        <div class="card teacher-card">
                            <!--<div class="card-body d-flex">-->
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    <h6 class="mb-0 mt-2  fw-bold d-block" style="font-size:20px">{{$edu->conference_name}}</h6>
                                    
                                    
                                    <span class="light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{{$edu->conference_organization_name}}</span>
                                    
                                    <div class="video-setting-icon mt-3 pt-3 border-top">
                                        
                                        <p><b>Date :</b> {{$edu->conference_date}}</p>
                                        <p><b>Venue :</b> {{$edu->conference_venue}}</p>

                                        <!--<p><b>From :</b> {{$edu->start_date}} &nbsp&nbsp  <b>To :</b> {{$edu->end_date}}</p>-->
                                        <p>{{$edu->description}}</p>
                                    </div>
                                    <a href="{{url('/user/editConferenceProceeding')}}/{{$edu->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-edit-alt me-2 fs-6"></i>Edit Conference Proceeding</a>
                                    <a href="{{url('/user/deleteConferenceProceeding')}}/{{$edu->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-delete-alt me-2 fs-6"></i>Delete Conference Proceeding</a>
                                </div>
                            </div>
                        <!--</div>-->
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Add Conference Proceeding</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/addConferenceProceeding')}}/{{$user->id}}">
                    @csrf
