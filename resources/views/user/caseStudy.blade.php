...
<head>
    ...
    <title>:: My-Profile:: Case Study</title>
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Case Studies</h3>
                                <button type="button" class="btn btn-dark me-1 mt-1 w-sm-100" data-bs-toggle="modal" data-bs-target="#createemp"><i class="icofont-plus-circle me-2 fs-6"></i>Add Case Study</button>
                ...
                <?php
                    $mems=\App\Models\CaseStudy::where("user_id",$user->id)->get();
                ?>
                            ...
                            <!--<div class="card-body d-flex">-->
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    ...
                                    <div class="video-setting-icon mt-3 pt-3 border-top">
                                        <p><b>Date :</b> {{$mem->case_date}}</p>
        
                                        <p>{{$mem->description}}</p>
                                    </div>
                                    <a href="{{url('/user/editCaseStudy')}}/{{$mem->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-edit-alt me-2 fs-6"></i>Edit Case Study</a>
                                    <a href="{{url('/user/deleteCaseStudy')}}/{{$mem->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-delete-alt me-2 fs-6"></i>Delete Case Study</a>
                                </div>
                            </div>
                        <!--</div>-->
                        </div>
        ...
        <div class="modal fade" id="createemp" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/addCaseStudy')}}/{{$user->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            <label for="exampleFormControlInput877" class="form-label">Case Study Title</label>
                            <input name="title" type="text" class="form-control" id="exampleFormControlInput877" placeholder="Enter Case Study Title">
                        </div>
                        <div class="col-sm-6">
                                        <label for="exampleFormControlInput3778" class="form-label">Date</label>
                                        <input name="case_date" type="date" class="form-control" id="exampleFormControlInput3778">
                                    </div>
