...
<head>
    ...
    <title>:: My-Profile:: Memberships</title>
...
<?php $user = Auth::guard('admin')->user(); ?>
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            ...
            <form method="post" enctype="multipart/form-data" action="{{ url('user/editMembership')}}/{{$MembershipDetails->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            ...
                            <input name="organization_name" type="text" class="form-control" id="exampleFormControlInput877" value="{{$MembershipDetails->organization_name}}" placeholder="Enter Organization Name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="deadline-form">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="start_date" type="date" class="form-control" value="{{$MembershipDetails->start_date}}" id="exampleFormControlInput3778">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="exampleFormControlInput2778" class="form-label">End Date</label>
                                        <input name="end_date" type="date" class="form-control" value="{{$MembershipDetails->end_date}}" id="exampleFormControlInput2778">
                                    </div>
                                </div>                            
                        </div>
                        <div class="mb-3">          
                            <label for="exampleFormControlTextarea78" class="form-label">Description (optional)</label>
                            <textarea name="description" class="form-control" id="exampleFormControlTextarea78" rows="3" placeholder="Add any extra details">{{$MembershipDetails->description}}</textarea>
                        </div> 
