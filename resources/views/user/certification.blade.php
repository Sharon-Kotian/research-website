    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 mb-4 no-bg">
                            <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0">Certification</h3>
                                <button type="button" class="btn btn-dark me-1 mt-1 w-sm-100" data-bs-toggle="modal" data-bs-target="#createemp"><i class="icofont-plus-circle me-2 fs-6"></i>Add Certification</button>
                ...
                <?php
                    $mems=\App\Models\Certification::where("user_id",$user->id)->get();
                ?>
                ...
                <div class="col">
                        <div class="card teacher-card">
                            <!--<div class="card-body d-flex">-->
                                ...
                                <h6 class="mb-0 mt-2  fw-bold d-block" style="font-size:20px">{{$mem->title}}</h6>
                                    ...
                                    <div class="video-setting-icon mt-3 pt-3 border-top">
                                        <p><b>From :</b> {{$mem->issue_date}} &nbsp&nbsp  <b>To :</b> {{$mem->expiry_date}}</p>
                                        <p>{{$mem->description}}</p>
                                    </div>
                                    <a href="{{url('/user/editCertification')}}/{{$mem->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-edit-alt me-2 fs-6"></i>Edit Certification</a>
                                    <a href="{{url('/user/deleteCertification')}}/{{$mem->id}}" class="btn btn-dark btn-sm mt-1"><i class="icofont-delete-alt me-2 fs-6"></i>Delete Certification</a>
                                </div>
                            </div>
                        <!--</div>-->
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Add Case Study</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/addCertification')}}/{{$user->id}}">
                    @csrf
                ...
                @endif
                  <div class="mb-3">     
                            ...
                            <input name="title" type="text" class="form-control" id="exampleFormControlInput877" placeholder="Enter Certification Title">
                        </div>
                        <div class="mb-3">     
                            <label for="exampleFormControlInput877" class="form-label">Issuing Organization Name</label>
                            <input name="organization_name" type="text" class="form-control" id="exampleFormControlInput877" placeholder="Enter Issuing Organization Name">
                        </div>
                        <div class="deadline-form">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="issue_date" type="date" class="form-control" id="exampleFormControlInput3778">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="exampleFormControlInput2778" class="form-label">Date of Expiry</label>
                                        <input name="expiry_date" type="date" class="form-control" id="exampleFormControlInput2778">
                                    </div>
